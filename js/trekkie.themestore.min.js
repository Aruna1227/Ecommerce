!(function () {
  var e = {
      ...
      5841: function (e, t, n) {
        ...
        function u() {
          return {
            m: l(o.ConsentKeys.MARKETING),
            a: l(o.ConsentKeys.ANALYTICS),
            p: l(o.ConsentKeys.PREFERENCES),
            s: l(o.ConsentKeys.SALE_OF_DATA),
          };
        }
        function d(e = null) {
          ...
          return fetch(`https://${u}/api/unstable/graphql.json`, d)
            ...
            .then((s) => {
              ...
              return (
                ...
                l !== d &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, l, c, p),
                  r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, l, c, f)),
                o.dispatchEvents(e),
                void 0 !== t && t(null, s),
                s
              );
      ...
      1930: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.13"),
          (t.storefrontAnalyticsSchemaIdValidation =
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "4afbe92a12849f4ce6c6ac28d983dff93bf9b53f",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                a.addBatchEvent({
                  ...
                  payload: {
                    build_id: "4afbe92a12849f4ce6c6ac28d983dff93bf9b53f",
      ...
      803: function (e, t, n) {
        ...
        const o = "sh",
          ...
          C = "checkout_payment_step_started",
          m = "session_started",
          E = "wpm",
          A = "trekkie";
        let T, S;
                ...
                (function (e, t) {
                  if (
                    ...
                    ((null == t ? void 0 : t.analyticsFramework) !== A &&
                      (null == t ? void 0 : t.analyticsFramework) !== E)
                  )
                    return k(r);
                  const n =
